...
public class Main {
    ...
    public static void main(String[] args) {
         ...
         * a hardcoded Week-array to it. Only one week, week 24, is populated,
         * the rest are 'null'. */
...
//som nok bliver en menu, hvor man kan access en vagtplan.
     ...
     * method to work optimally is to have 5 Employee-object in the ArrayList. It makes a Week-array,
     * and populates one week, week 24, with a Week-object. First the method makes five Day-objects
     * with times for when the shift starts and ends. Then it creates a Day-array with those five 
     ...
     * ArrayList for WorkHours and add these five WorkHours-objects. Toweards the end a Week-object,
     * w24 for week 24, is created with the ArrayList<WorkHours> in it.  A Week[] with a length of 52
     * elements is created, corresponding to one for each week of the year. w24 is put in on the 24th
     * position, weeks[23], in the array. This array is then set as the Weeks-field of the Year-object. */
    public static void addHardcodedWeekToYear(Year year, ArrayList<Employee> employees){
        ...
        Week w24 = new Week(24, workHours);
        Week[] weeks = new Week[52];
        weeks[w24.getWeek() - 1] = w24;
        year.setWeeks(weeks);
    }
}
